...
export class SupplierService {
  ...
  constructor(private http: HttpClient) {
    // this.suppliersWithConcatMap$.subscribe(item => console.log('concat result', item));
    // this.suppliersWithMergeMap$.subscribe(item => console.log('merge result', item));
    // this.suppliersWithSwitchMap$.subscribe(item => console.log('switch result', item));
  }
